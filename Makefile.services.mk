# docker-compose.services.yml — gộp với docker-compose.yml.
# d-up-all: ensure-shared-network + ensure-gateway-sites → up toàn bộ stack.
...
d-services-up: ensure-shared-network
...
d-up-all: ensure-shared-network ensure-gateway-sites
